...
function ajaxRequestBasica() {
        ...
        ajax_req.open('POST','municipios.jsp?', true);//Abre a conexão tipo, url e boolean indicando se é assíncrona
        ajax_req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        ajax_req.send('uf='+filtroUF);//Informação a ser enviada junto, utilizado no POST
