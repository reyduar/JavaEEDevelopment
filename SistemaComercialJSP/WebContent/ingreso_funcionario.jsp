...
<%@ page import="java.util.List, ar.iariel.siscom.model.bean.Departamento"%>
...
<body>
	...
	<div align="center">
		<form action="SiscomController"
			...
			<h3>${mensagem}</h3>
			<input type="hidden" name="cmd" value="ingresoFuncionario"></input>
			<table
						...
						name="departamento_codigo">
							<%
								...
								for (Departamento departamento : departamentos) {
									out.println("<option value='" + departamento.getCodigo() + "'>"
				...
				<tr>
					<td>Acesso total</td>
					<td><input type="checkbox" id="idactotal" name="actotal"
						style="height: 20px" value="${funcionario.actotal}"></input></td>
				</tr>
				<tr>
					<td>Login :</td>
				...
				<tr>
					<td colspan="2" align="center"><input type="submit"
						value="Finalizar Ingreso de Funcionario" style="height: 23px"></input></td>
				</tr>
			</table>
			<br>
		</form>
