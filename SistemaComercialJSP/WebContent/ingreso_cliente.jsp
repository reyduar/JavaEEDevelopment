...
<div align="left">
	...
	<h3 style="color: #0000FF; text-transform: capitalize; font-style: italic; font-size: 15px; font-family: Verdana, Arial, Sans-Serif; font-weight: bold">${mensagem}</h3>
		...
		border="1" bordercolor="gray" cellpadding="5">
			...
			<tr>
				<td style="color: #000000; text-transform: capitalize; font-size: 15px; font-family: Tahoma, Verdana, Arial, Sans-Serif">Nombre </td>
			...
			<tr style="background-color: #FFFFFF">
				<td colspan="2" align="center"><input type="submit" value="Finalizar Ingreso de Cliente"></td>
			</tr>
		</table>
	</form>
</div>
