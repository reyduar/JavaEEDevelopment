 ...
 *
 */
public class ActualizarProducto implements InterfaceCommand {

	@Override
	public String execute(HttpServletRequest request,HttpServletResponse response) {
		Articulo articuloBean = null;
		try {
			...
			articuloBean = articuloDAO.getBean(Integer.valueOf(request.getParameter("codigo")));
			...
			if(articuloBean.isValido() && request.getMethod().equalsIgnoreCase("post")){
				
				articuloDAO.actualizar(articuloBean);
				request.setAttribute("mensagem", "Producto " +articuloBean.getArtnomreal()+" actualizado con éxito :) ");
